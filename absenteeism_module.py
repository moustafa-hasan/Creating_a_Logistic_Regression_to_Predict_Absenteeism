...
class absenteeism_model():
        ...
        def load_and_clean_data(self, data_file):
            ...
            # Modified by me
            # self.data = StandardScaler().transform(df)
            # self.data = pd.DataFrame(self.scaler.transform(df.columns))
            # self.data = self.scaler.transform(df, columns=df.columns)
            self.data = StandardScaler().fit(df).transform(df)
